...
public class MD5Util {
    ...
    public static String getMD5ofStr(byte[] bytes) {
        try {
            MessageDigest md5 = MessageDigest.getInstance("MD5");
            md5.update(bytes);
            byte[] digest = md5.digest();
    ...
    public static void main(String[] args) {
        String str = "fba8c864d8c14f8db69c337301d22177";

        System.out.println(getMD5ofStr(getMD5ofStr("fba8c864d8c14f8db69c337301d22177")));
    }
}
