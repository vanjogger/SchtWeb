...
<div class="container">
  <form id="J_Form" class="form-horizontal" action="/advertPlace/update">
      ...
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="code" type="text" data-rules="{required:true,maxlength:20}"
                 value="${data.code}" class="input-large control-text">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="width" type="text" data-rules="{regexp:/^\d+$/}" data-messages="{regexp:'请输入整数'}"
                 value="${data.width}" class="input-small  number-text">px
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="height" type="text" data-rules="{regexp:/^\d+$/}" data-messages="{regexp:'请输入整数'}"
                 value="${data.height}" class="input-small  number-text">px
        </div>
      </div>
    </div>
    <div class="row">
