...
<div class="container">
  <form id="J_Form" class="form-horizontal" action="/advert/save">
    <div class="row">
        ...
        <div class="controls">
         <select name="placeId" data-rules="{required:true}" onchange="sSize(this)">
           ...
           <c:forEach items="${places}" var="e">
             <option value="${e.id}" data-width="${e.width}" data-height="${e.height}">${e.title}</option>
           </c:forEach>
         </select>
        </div>
      </div>
    ...
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="url" type="text" value="" class="input-large control-text">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input id="startTime" type="text" value="" data-rules="{required:true}" class="calendar">~
          <input id="endTime" type="text" value="" data-rules="{required:true}" class="calendar">
        </div>
      </div>
    </div>
    　<div class="row">
    <div class="control-group span20">
      ...
      <div class="controls">
        ...
        <label class="radio" for="status2"><input id="status2" type="radio" name="status" value="FROZEN">关闭</label>
      </div>
    </div>
  </div>
    　<div class="row">
    ...
    <div class="control-group span20">
      ...
      <div class="controls">
        <input name="sort" class="input-small control-text" value="1" data-rules="{regexp:/^\d+$/}" data-messages="{regexp:'请输入整数'}">
      </div>
    </div>
  </div>
