...
<div class="container">
  <form id="J_Form" class="form-horizontal" action="/hotkey/save">
    <div class="row">
      <div class="control-group span20">
        <label class="control-label"><s>*</s>热词：</label>
        <div class="controls">
          <input name="name" type="text" data-rules="{required:true,maxlength:100}" value="" class="input-normal control-text" style="width:200px;">
        </div>
      </div>
    </div>
