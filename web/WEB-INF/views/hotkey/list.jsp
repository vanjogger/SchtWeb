...
<script type="text/javascript">
  ...
  BUI.use(['common/search','common/page','bui/grid','bui/overlay','bui/form'],function (Search,Page,Grid,Overlay,Form) {
    var  columns = [
      {title:'序号',dataIndex:'sort',width:100},
      {title:'热词',dataIndex:'name',width:200},
  ...
  function del(id){
    BUI.Message.Confirm("确定删除吗？",function(){
      $.ajax({
        url :"/hotkey/delete?r="+Math.random(),
        type : 'post',
        data : {id:id},
