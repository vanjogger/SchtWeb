...
<div class="container">
  <form id="J_Form" class="form-horizontal" action="/admin/member/update">
    <input type="hidden" name="id" value="${data.id}"/>
    <div class="row">
      <div class="control-group span20">
        <label class="control-label"><s>*</s>会员账号：</label>
        <div class="controls">
          <input name="account" type="text" data-tip="{text:'请输入会员账号'}" readonly
                 data-rules="{required:true,maxlength:100}" value="${data.account}" class="input-normal control-text" style="width:200px;">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="password" type="password" data-tip="{text:'不修改可以不填写'}"
                 data-rules="{maxlength:32}" value="" class="input-normal control-text" style="width:200px;">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="nick" type="text" data-tip="{text:'请输入会员昵称'}"
                 value="${data.nick}" class="input-normal control-text" style="width:200px;">
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="address" type="text" data-tip="{text:'请输入家庭住址'}"
                 value="${data.address}" class="input-large control-text" style="width:200px;">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="qq" type="text" data-tip="{text:'请输入联系QQ'}"
                 value="${data.qq}" class="input-normal control-text" style="width:200px;">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="control-group span20">
        ...
        <div class="controls">
          <input name="weixin" type="text" data-tip="{text:'请输入联系微信'}"
                 value="${data.weixin}" class="input-normal control-text" style="width:200px;">
        </div>
      </div>
    </div>
    <div class="row">
...
<script type="text/javascript">
  ...
  BUI.use(['bui/tree','bui/form','bui/uploader'],function (Tree,Form,Uploader) {
    ...
    $("#J_Uploader ul").append('<li class="bui-queue-item bui-queue-item-success">' +
            '<div class="success"><img src="${data.headIcon}" ' +
